...
getEN stringKey =
    case stringKey of
        ...
        BOOKINGS_WILL_BE_CANCELLED_WITH_REFUND number -> "All tickets associated with this booking will be canceled, and you will receive a refund of " <> number 
        ...
        SHAKE_TO_ACTIVATE_SUB -> "You can shake your device while on the app during a ride to access the emergency actions."
        ...
        CURRENT_INITIATIVES_SUB -> "Goals we are working towards to ensure  even better ride safety"
