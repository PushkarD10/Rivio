...
getFR stringKey =
    case stringKey of
        ...
        RESEND_OTP -> "<a href=\"\">Renvoyer un code à usage unique</a>"
        ...
        NEED_IT_TO_ENABLE_LOCATION _ -> "Namma Yatri Partner recueille des données de localisation afin de partager votre position pour suivre la position du conducteur en direct, même lorsque l'application est fermée ou n'est pas utilisée"
        ...
        RESEND_OTP_IN -> "<u>Renvoyer le code à usage unique dans "
        ...
        PICKUP -> "Pick-up"
        TRIP -> "Trajet"
        CURRENTLY_WE_ALLOW_ONLY_KARNATAKA_REGISTERED_NUMBER _ -> "Actuellement, nous n'autorisons que les numéros enregistrés au Karnataka"
        UPDATED_AT -> "Carte mise à jour à"
        TRIP_COUNT -> "Compteur de trajets"
        TODAYS_EARNINGS -> "Gains"
        TODAYS_EARNINGS_STR -> "Gains"
        ...
        REPORT_ISSUE_CHAT_PLACEHOLDER _ -> "Décrivez votre problème Namma Yatri essaiera de le résoudre en moins de 24 heures"
        ...
        CORPORATE_ADDRESS _ -> "Adresse d'entreprise"
        CORPORATE_ADDRESS_DESCRIPTION _ -> "Moving Tech Innovations Private Limited <br> Girija Building, numéro 817, Ganapathi Temple Rd, 8th Block, Koramangala, Bengaluru, Karnataka 560095, Inde"
        CORPORATE_ADDRESS_DESCRIPTION_ADDITIONAL _ -> "Website: <u> https://nammayatriin/ </u>"
        REGISTERED_ADDRESS _ -> "Adresse enregistrée"
        ...
        REGISTERED_ADDRESS_DESCRIPTION_ADDITIONAL _ -> "Website : <u> https://nammayatriin/ </u>"
        NEW_ -> "Nouvelle"
        WITH -> "avec"
        ...
        CHOOSE_YOUR_PLAN _ ->  "Choisissez un plan maintenant!"
        ...
        PAYMENT_PENDING_ALERT_DESC _ ->  "Pour continuer à faire des trajets sur Namma Yatri, effacez vos frais de paiement"
        ...
        HOW_IT_WORKS _ ->  "Comment ça marche"
        ...
        VIEW_FAQs ->  "View FAQs"
        FIND_HELP_CENTRE _ ->  "Trouver le centre d'aide"
        CONTACT ->  "Contact"
        ...
        RENTAL_BOOKINGS -> "Réservations de location"
        RENTAL_BOOKINGS_DESCRIPTION -> "Vous pouvez choisir d'être disponible pour les réservations de location"
        WHAT_ARE_PURPLE_RIDES ->  "Qu'est-ce que les Purple Rides ?"
        ECONOMICAL ->  "Économique"
        SPACIOUS ->  "Spacieux"
        COMFY ->  "Confortable"
        PEOPLE ->  "personnes"
        GET_READY_FOR_YS_SUBSCRIPTION _ ->  "Préparez-vous pour les plans Yatri Sathi !"
        SIGNUP_EARLY_FOR_SPECIAL_OFFERS ->  "Inscrivez-vous tôt pour bénéficier d'offres spéciales"
        GUARANTEED_FIXED_PRICE _ ->  "Prix fixe garanti jusqu'au 1er janvier 2025"
        INTRODUCTORY_OFFER_TO_BE_ANNOUNCED_SOON ->  "L'offre de lancement sera bientôt annoncée !"
        NO_CHARGES_TILL ->  "Aucun frais jusqu'au {}"
        ...
        SUBSCRIPTION_PLAN_STR _ -> "Plan d'abonnement"
        ...
        DISMISS -> "Rejeter"
        EARNINGS -> "Gains"
        YATRI_POINTS -> "Pièces Yatri"
        DISCOUNT_POINTS -> "Points de réduction"
        YATRI_POINTS_STR -> "Pièces Yatri"
        INTRODUCING_YATRI_POINTS -> "Présentation des les points Yatri"
        NOW_EARN_POINTS_FOR_EVERY_RIDE_AND_REFERRAL_AND_USE_THEM_TO_GET_REWARDS _ -> "Gagnez maintenant des les points pour chaque trajet et référence, et utilisez-les pour obtenir des récompenses"
        PAID_BY_YATRI_POINTS -> "Payé par des les points Yatri"
        DISCOUNT_POINTS_SMALL -> "points de réduction"
        YATRI_POINTS_USAGE_POPUP _ -> "Les les points Yatri seront converties en réductions que vous pouvez utiliser contre votre plan d'abonnement"
        USE_POINTS_NOW -> "Utiliser des les points maintenant"
        BUY_NOW -> "Acheter maintenant"
        SELECT_DATE -> "Sélectionner une date"
        WHAT_WILL_MY_POINTS_BE_CONVERTED_TO -> "À quoi mes les points seront-elles converties ?"
        POINTS_EXPIRING_IN_THE_NEXT -> "{} les points expirant dans les {} prochains jours. Utilisez-les avant leur expiration."
        DAYS_USE_THEM_BEFORE_THEY_EXPIRE -> "jours. Utilisez-les avant qu'ils n'expirent"
        POINTS_EXPIRING -> "Pièces expirant"
        NO_POINTS_AVAILABLE -> "Aucune pièce disponible"
        FAILED_TO_USE_POINTS_PLEASE_TRY_AGAIN_LATER -> "Échec de l'utilisation des les points. Veuillez réessayer plus tard"
        BAD_RATING_BY_CUSTOMER -> "Mauvaise note par le client"
        RIDE_CANCELLATION -> "Annulation du trajet"
        CUSTOMER_REFERRAL -> "Référence client"
        CUSTOMER_SHOULD_COMPLETE_A_VALID_RIDE -> "Le client doit effectuer un trajet valide"
        DRIVER_REFERRAL -> "Référence du conducteur"
        PURPLE_RIDE_COMPLETED -> "Purple Ride terminé"
        TRAINING_COMPLTED -> "Formation terminée"
        RIDES_IN_A_DAY -> "Trajets en un jour"
        TOP -> "Haut"
        IN_WEEKLY_LEADERBOARD -> "dans le classement hebdomadaire"
        TRIP_EARNINGS -> "Gains de voyage"
        EXTRA_EARNINGS -> "Gains supplémentaires"
        TRIPS -> "Trajets"
        VIEW_MORE -> "Voir plus"
        MINIMUM -> "Minimum"
        POINTS_IS_REQUIRED_FOR_CONVERSION -> "Les les points sont nécessaires pour la conversion"
        DISCOUNT -> "Remise"
        CHECK_NOW -> "Vérifier maintenant"
        COIN_BALANCE -> "les points restantes"
        POINTS_BALANCE -> "Solde des les points"
        TOTAL_EARNED -> "Total Gagné"
        RIDE_HISTORY -> "histoire de balade"
        TRANSACTION_HISTORY -> "Historique des transactions"
        POINTS_EARNED -> "les points gagnées"
        NO_RIDES -> "Pas de manèges"
        POINTS_USED -> "les points utilisées"
        USE_POINTS -> "utiliser des les points"
        INSIGHTS -> "connaissances"
        USAGE_HISTORY -> "historique d'utilisation"
        NO_POINTS_EARNED -> "aucune pièce gagnée"
        NO_POINTS_USED -> "aucune pièce utilisée"
        EARN_POINTS_BY_TAKING_RIDES_AND_REFERRING_THE_APP_TO_OTHERS _ -> "Gagnez des les points en faisant des courses et en référant l'application à d'autres"
        USE_THEM_BEFORE_THEY_EXPIRE -> "Utilisez-les avant leur expiration"
        NO_RIDE_HISTORY_AVAILABLE -> "Aucun historique de trajet disponible"
        YOU_HAVE_NOT_COMPLETED_A_RIDE_YET -> "Vous n'avez pas encore terminé un trajet"
        COMPLETE_FIRST_RIDE_TO_UNLOCK_POINTS -> "Terminez le premier tour pour débloquer des les points"
        DESTINATION -> "Destination"
        YOU_DID_NOT_TAKE_ANY_RIDES_ON_PREFIX -> "Vous n'avez effectué aucun trajet le"
        YOU_DID_NOT_TAKE_ANY_RIDES_ON_SUFFIX -> ""
        CONVERT -> "Convertir"
        CONVERT_POINTS -> "Convertir des les points"
        CASH_CONVERTED -> "Espèces converties"
        WILL_BE_ADJUSTED_IN_YOUR_FUTURE_SUBSCRIPTION_DUES -> "{} sera ajusté dans votre future cotisation"
        HAS_BEEN_ADJUSTED_IN_YOUR_SUBSCRIPTION_DUES -> "{} a été ajusté dans votre cotisation"
        USING_POINTS_REQUIRES_AN_ACTIVE_PLAN -> "L’utilisation de Points nécessite un plan actif."
        TO_GET_STARTED -> "pour commencer"
        CONVERTED_FROM_POINTS -> "converti à partir de les points de monnaie"
        YATRI_POINTS_FAQS  -> "Pièces Yatri Questions Générales"
        LEARN_ABOUT_YATRI_POINTS  -> "En savoir plus sur les les points Yatri"
        YATRI_POINTS_FAQS_QUES1 _ -> "Qu'est-ce que Yatri Points?"
        YATRI_POINTS_FAQS_QUES1_ANS1 _ -> "Les Yatri Points sont les récompenses que vous gagnez lors d'activités quotidiennes sur Namma Yatri comme des manèges, des références, de bonnes notes, etc."
        YATRI_POINTS_FAQS_QUES1_ANS2 _ -> "Les points Yatri gagnés vous donnent droit à des points de réduction, qui peuvent être utilisés sur la plateforme."
        YATRI_POINTS_FAQS_QUES1_ANS3 _ -> "Chaque point Yatri peut être converti en 0,1 point de réduction, qui sera ajusté en fonction des frais d'abonnement selon le plan."
        YATRI_POINTS_FAQS_QUES2 _ -> "Quelle est la validité des Yatri Points?"
        YATRI_POINTS_FAQS_QUES2_ANS1 days -> "Les Yatri Points sont valables pour une période de "<> days <>" jours à compter du jour où elles sont gagnées. Pendant cette période, vous pouvez utiliser les les points pour bénéficier d’avantages."
        YATRI_POINTS_FAQS_QUES2_ANS2 days -> "Les Yatri Points non échangés dans les "<> days <>" jours seront perdus"
        YATRI_POINTS_FAQS_QUES3 _ -> "Comment puis-je gagner des les points Yatri ?"
        YATRI_POINTS_FAQS_QUES3_ANS1 _ -> "Les les points sont gagnées grâce aux activités quotidiennes sur l'application telles que les trajets, les recommandations de clients. Vous n'avez rien de différent à faire."
        YATRI_POINTS_FAQS_QUES3_ANS2 _ -> "Vous pouvez gagner plus de les points en adoptant un bon comportement, comme peu d'annulations, en obtenant de bonnes évaluations de la part des clients, etc."
        YATRI_POINTS_FAQS_QUES4 _ -> "Comment puis-je utiliser les Yatri Points que j'ai gagnées?"
        YATRI_POINTS_FAQS_QUES4_ANS1 _ -> "Vous pouvez utiliser les les points gagnées pour acheter des plans d'abonnement gratuitement pendant la période de validité."
        YATRI_POINTS_FAQS_QUES4_ANS2 _ -> "À l'avenir, d'autres options seront ajoutées pour utiliser les Yatri Points."
        YATRI_POINTS_FAQS_QUES4_ANS3 _ -> "Les Yatri Points ne peuvent pas être utilisées à d'autres fins que celles de bénéficier de réductions."
        YATRI_POINTS_FAQS_QUES5 _ -> "Quelle est l’éligibilité pour gagner et utiliser des Yatri Points ?"
        YATRI_POINTS_FAQS_QUES5_ANS1 _ -> "Vous devez effectuer votre premier trajet avec Namma Yatri pour commencer à gagner des Yatri Points."
        YATRI_POINTS_FAQS_QUES5_ANS2 _ -> "La section des Yatri Points sera désactivée jusqu'à ce que vous ayez effectué votre premier trajet."
        YATRI_POINTS_FAQS_QUES6 _ -> "Combien de les points puis-je gagner ou perdre pour diverses actions ?"
        YATRI_POINTS_FAQS_QUES6_ANS1 _ -> "Les les points sont gagnées ou perdues pour diverses actions selon le tableau suivant :"
        TASK_COMPLETED -> "Tâche terminée"
        RIDES_IN_A_DAY_PREFIX -> ""
        RIDES_IN_A_DAY_SUFFIX -> " courses par jour"
        STAR_RATING_FOR_THE_TRIP -> "Note de 5 étoiles pour le voyage"
        ONE_TWO_START_RATING -> "Note de 1 ou 2 étoiles pour le voyage"
        BOOKING_CANCELLATION -> "Annulation de réservation"
        PAID_BY -> "Payé par"
        DRIVER_REFERRAL_CODE -> "Code de \n référence du conducteur"
        APP_QR_CODE -> "Code QR de l'application"
        START_TAKING_RIDES_AND_REFER _ -> "Commencez à faire des courses et à recommander des chauffeurs pour vous inscrire sur l'application Namma Yatri Driver"
        REFERRED_DRIVERS -> "Chauffeurs recommandés"
        RIDE_LEADERBOARD -> "Classement des courses"
        YOUR_RANK -> "Ton rang"
        NOT_AVAILABLE_YET -> "Pas encore disponible"
        ENTER_REFERRAL_CODE -> "Entrez le code de parrainage"
        HAVE_A_REFERRAL_CODE -> "Vous avez un code de parrainage ?"
        ...
        HELP_FAQ -> "Aide"
        BONUS_POINTS -> "Pièces bonus"
        MAX -> "Max"
        COINS -> "Pièces"
        POINTS_ADDED -> "Pièces ajoutées"
        ...
        REFERRED -> "Référencé"
        ACTIVATED -> "Activé"
        REFER_DRIVER -> "Référez un chauffeur"
        REFER_CUSTOMER -> "Référez un client"
        REFERRED_DRIVERS_INFO _ -> "Les conducteurs recommandés qui se sont inscrits sur Namma Yatri"
        REFERRED_CUSTOMERS_INFO _ -> "Les clients recommandés qui se sont inscrits sur Namma Yatri"
        ...
        WE_GUARANTEE_YOU -> "Nous vous garantissons"
        ...
        CHECK_APP -> "Vérifier l'application"
        CHECK_YOUR_APP_BY_TEST_RIDE_REQUEST -> "Vérifiez votre application en envoyant une demande d'essai"
        PLEASE_TRY_THE_FOLLOWING_STEPS -> ""
        GET_SUPPORT_ON_WHATSAPP -> ""
        KNOW_ABOUT_POINTS -> "En savoir plus sur les les points"
        NOT_ENOUGH_POINTS_DESCRIPTION -> "Vous n'avez pas assez de solde de les points. Veuillez sélectionner une valeur inférieure à convertir"
        SHARE -> "Partager"
        ...
        UPCOMING_STOP -> "Prochain arrêt"
        LAST_STOP -> "Dernier arrêt"
        PREVIOUS_STOP -> "Arrêt précédent"
        ...
        TIMEOUT -> "TEMPS MORT"
        RIDE_MORE_AND_EARN_POINTS -> "Faites plus de trajets et gagnez des les points"
        RIDE_MORE_EARN_MORE -> "Voyagez plus, gagnez plus !"
        TAKE_MORE_RIDES_TO_EARN_MORE_POINTS_AND_CONVERT_IT_TO_SUBSCRIPTION_DISCOUNTS -> "Les les points peuvent être utilisées pour obtenir des réductions sur les frais d'abonnement."
        CHECK_YATRI_POINTS -> "Vérifiez les les points Yatri"
        TWO_MORE_RIDES_TO_GO -> "Deux trajets de plus à faire"
        TAKE_TWO_MORE_RIDES_TO_EARN_POINTS coinValue -> "Faites deux trajets de plus et gagnez " <> coinValue <> " les points"
        ONE_MORE_RIDE_TO_GO -> "Un trajet de plus à faire"
        TAKE_ONE_MORE_RIDE_TO_EARN_POINTS coinValue -> "Faites un trajet de plus et gagnez " <> coinValue <> " les points"
        CONGRATULATIONS -> "Félicitations"
        YOU_HAVE_EARNED_POINTS_FOR_COMPLETING_EIGHT_RIDES coinValue -> "Vous avez gagné " <> coinValue <> " les points pour avoir terminé huit trajets"
        REFER_NAMMA_YATRI_APP_TO_CUSTOMERS_AND_EARN_POINTS _ -> "Référez l'application Namma Yatri à des clients et gagnez des les points"
        REFER_NOW -> "Référez maintenant"
        CONVERT_YOUR_POINTS_TO_DISCOUNT -> "Convertissez vos les points en réduction"
        CONVERT_YOUR_POINTS_TO_GET_DISCOUNT_ON_YOUR_SUBSCRIPTION -> "Convertissez vos les points pour obtenir une réduction sur votre plan d'abonnement"
        ...
        CUSTOMER_CALLING_AND_MESSAGING -> "Appels et messagerie client"
        WAITING_CHARGES -> "Frais d'attente"
        CUSTOMER_TIPS -> "Conseils du client"
        CANCELLATION_CHARGES -> "Frais d'annulation"
        MERCHANT_POINTS merchant -> "Pièces de monnaie " <> merchant
        MERCHANT_NAME _ -> "Namma Yatri"
        THIRD_PARTY_RIDES -> "Trajets de tiers"
        THIRD_PARTY_RIDES_ARE_REQUESTED_WITH_BY_A_USERS_FROM_ANOTHER_APP -> "Les trajets de tiers sont demandés par un utilisateur depuis une autre application."
        SOME_FEATURES_MAY_NOT_BE_AVAILABLE -> "Certaines fonctionnalités peuvent ne pas être disponibles."
        WHY -> "Pourquoi ?"
        ...
        DISCOUNTED -> "Remisé"
        CANNOT_DETECT_PAN_CARD -> "Impossible de détecter le de la carte PAN. Veuillez réessayer."
        CANNOT_DETECT_AADHAAR -> "Impossible de détecter le carte Aadhaar. Veuillez réessayer."
        DOCUMENT_ALREADY_VALIDATED -> "document déjà validé."
        DOCUMENT_UNDER_MANUAL_REVIEW -> "document en cours de révision manuelle"
        DOCUMENT_ALREADY_LINKED_TO_ANOTHER_DRIVER -> "Document déjà lié à un autre conducteur."
        PAN_ALREADY_LINKED -> "casserole déjà liée."
        ...
        ADD_PHOTOS -> "Ajoutez vos photos"
        ADD_UPTO_FOUR -> "Vous pouvez ajouter jusqu'à 4 photos"
        CARD_TEXT -> "Vous pouvez partager des photos de vous, de votre famille et de votre véhicule pour les montrer à nos clients !"
        PLEDGE -> "Ce que je m'engage à faire"
        SAFE_JOURNEY -> "Voyage sécurisé"
        CLEAN_CAR -> "Voiture propre"
        ON_TIME_PICK_UP -> "Ramassage à l'heure"
        MAINTENANCE -> "Entretien régulier"
        VEHICLE_OFFER -> "Ce que mon véhicule offre"
        GAS -> "Essence"
        RADIO -> "Radio"
        ECO_FRIENDLY -> "Écologique"
        DEVICE_CHARGING -> "Recharge des appareils"
        BOOT_SPACE -> "Espace de coffre"
        ...
        ADD_PHOTO_CAPTION -> "Vous pouvez ajouter des photos de vous et de votre famille pour les montrer à nos clients ! Soyez attentif à ce que vous ajoutez."
        COMPLETE_PROFILE -> "Complétez le profil"
        SAVE -> "Enregistrer"
        SELECT_FACILITIES -> "Sélectionnez les équipements que votre ambulance doit avoir pour obtenir des trajets en fonction de cela.\n Remarque: Le ventilateur comprend la climatisation et l'oxygène."
        FIRST_AID_KIT -> "À tout moment, les ambulances doivent avoir un brancard et une trousse de premiers secours disponibles."
        DRIVER_ACKNOWLEDGE -> "Le conducteur reconnaît et assume la pleine responsabilité de la sélection et de la garantie du bon fonctionnement des installations conformément à la préférence de réservation choisie."
        BOOKING_PREFERENCE ->"Les conducteurs peuvent changer la variante/les équipements pour correspondre à leur préférence de réservation et à l'état des équipements."
        INSPECTION -> "Les fournisseurs d'ambulances doivent rendre leurs ambulances disponibles pour des inspections aléatoires du département de la santé à tout moment. Toute anomalie constatée lors des inspections entraînera des mesures juridiques immédiates."
        A_F -> "Équipements d'ambulance"
        BY_PROCEEDING_YOU_ACCEPT_FULL_RESPONSIBILITY -> "En procédant, vous acceptez la pleine responsabilité des installations d'ambulance et acceptez des inspections aléatoires du département de la santé, avec des actions légales pour toute anomalie."
        ...
        SELECT_ONE -> "Sélectionner une installation"
        FIRST_RIDE_FREE count -> "First " <> count <> " ride free"
        MANAGE_VEHICLE -> "Gérer les véhicules"
        AMBULANCE_IS_NOT_SUPPORTED_YET -> "L'ambulance n'est pas encore prise en charge"
        WE_WILL_NOFITY_YOU_WHEN_IT_IS_AVAILABLE -> "Nous vous informerons lorsque le soutien aux ambulances sera disponible dans votre ville"
        CANNOT_DETECT_PAN_CARD -> "Impossible de détecter le de la carte PAN. Veuillez réessayer."
        CANNOT_DETECT_AADHAAR -> "Impossible de détecter le carte Aadhaar. Veuillez réessayer."
        DOCUMENT_ALREADY_VALIDATED -> "document déjà validé."
        DOCUMENT_UNDER_MANUAL_REVIEW -> "document en cours de révision manuelle"
        ...
        CANCELLATION_RATE_TRIVIA -> "Comment réduire le taux d'annulation :"
