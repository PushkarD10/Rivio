...
getHI stringKey =
    case stringKey of
        ...
        TOLL_CHARGES_INCLUDING amount -> "टोल शुल्क " <> amount <> " किराए में शामिल किया गया है"
        TOLL_ROAD_CHANGED -> "टोल शुल्क लागू नहीं"
        PARKING_CHARGE -> "पार्किंग शुल्क"
        FARE_FOR limit -> limit <> " के लिए किराया"
        WAITING_CHARGE_LIMIT timeLimit -> timeLimit <> " मिनटों के बाद प्रतीक्षा शुल्क"
        ...
        ONLY_5_MORE_RIDES_FOR_N_POINTS n -> "केवल 5 और सवारियां बाकी हैं और "<> n <>" अंक प्राप्त करें"
        ONLY_3_MORE_RIDES_FOR_N_POINTS n -> "केवल 3 और सवारियां बाकी हैं और "<> n <>" अंक प्राप्त करें"
        ...
        AMBULANCE_IS_NOT_SUPPORTED_YET -> "अंबुलेंस अभी तक समर्थित नहीं है"
        WE_WILL_NOFITY_YOU_WHEN_IT_IS_AVAILABLE -> "जब आपके शहर में अंबुलेंस समर्थन उपलब्ध हो जाएगा, तो हम आपको सूचित करेंगे"
        CANNOT_DETECT_PAN_CARD -> "पैन कार्ड का पता नहीं चल सका। कृपया पुन: प्रयास करें।"
        CANNOT_DETECT_AADHAAR -> "आधार कार्ड का पता नहीं चल सका. कृपया पुन: प्रयास करें।"
        DOCUMENT_ALREADY_VALIDATED -> "दस्तावेज़ पहले से ही मान्य है।"
        DOCUMENT_UNDER_MANUAL_REVIEW -> "दस्तावेज़ की मैन्युअल समीक्षा की जा रही है।"
