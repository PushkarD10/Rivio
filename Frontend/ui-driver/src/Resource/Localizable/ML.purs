...
getML stringKey =
    case stringKey of
        ...
        TOLL_CHARGES_INCLUDING amount -> "ടോൾ ചാർജുകൾ " <> amount <> " നിരക്കിൽ ഉൾപ്പെടുത്തിയിരിക്കുന്നു"
        TOLL_ROAD_CHANGED -> "ടോൾ ചാർജുകൾ ബാധകമല്ല"
        PARKING_CHARGE -> "പാർക്കിംഗ് ചാർജുകൾ"
        FARE_FOR limit -> limit <> "  ക്കുള്ള നിരക്ക്"
        WAITING_CHARGE_LIMIT timeLimit -> timeLimit <> " മിനിറ്റുകൾക്കുശേഷം കാത്തിരുപ്പ് ചാർജുകൾ"
        ...
        ONLY_5_MORE_RIDES_FOR_N_POINTS n -> n <> " പോയിൻ്റിനായി 5 റൈഡുകൾ മാത്രം"
        ONLY_3_MORE_RIDES_FOR_N_POINTS n -> n <> " പോയിൻ്റിന് 3 റൈഡുകൾ മാത്രം"
        ...
        SAVE -> "സംരക്ഷിക്കുക"        MANAGE_VEHICLE -> "വാഹനങ്ങളെ നിയന്ത്രിക്കുക"
        AMBULANCE_IS_NOT_SUPPORTED_YET -> "ആംബുലൻസ് ഇതോടൊപ്പം പിന്തുണയ്ക്കപ്പെടുന്നില്ല"
        WE_WILL_NOFITY_YOU_WHEN_IT_IS_AVAILABLE -> "നിങ്ങളുടെ നഗരത്തില്‍ അംബുലൻസ് പിന്തുണ ലഭിക്കുമ്പോൾ ഞങ്ങൾ നിങ്ങളെ അറിയിക്കും"
        CANNOT_DETECT_PAN_CARD -> "പാൻ കാർഡ് കണ്ടെത്താൻ കഴിയുന്നില്ല. ദയവായി വീണ്ടും ശ്രമിക്കുക."
        CANNOT_DETECT_AADHAAR -> "ആധാർ കാർഡ് കണ്ടെത്താൻ കഴിയുന്നില്ല. ദയവായി വീണ്ടും ശ്രമിക്കുക."
        DOCUMENT_ALREADY_VALIDATED -> "പ്രമാണം ഇതിനകം സാധൂകരിച്ചിരിക്കുന്നു."
        DOCUMENT_UNDER_MANUAL_REVIEW -> "മാനുവൽ അവലോകനത്തിന് കീഴിലുള്ള പ്രമാണം."
