...
clearCacheByType :: (CacheFlow m r, EsqDBFlow m r) => Id MerchantOperatingCity -> LeaderBoardType -> m ()
clearCacheByType merchantOpCityId leaderBType =
...
clearConfigCache :: (CacheFlow m r, EsqDBFlow m r) => Id MerchantOperatingCity -> LeaderBoardType -> m ()
clearConfigCache merchantOperatingCityId leaderBType = do
  clearCache merchantOperatingCityId
  clearCacheByType merchantOperatingCityId leaderBType
